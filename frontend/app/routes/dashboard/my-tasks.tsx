...
// import { ArrowUpRight, CheckCircle, Clock, FilterIcon, Loader } from 'lucide-react';
...
//   const inProgresssTasks = sortedTasks.filter(
...
//         >
//           {sortDirection === 'asc' ? 'Oldest Firts' : 'Newest First'}
//         </Button>
...
//             <DropdownMenuItem onClick={() => setFilter('achieved')}>Achieved</DropdownMenuItem>
...
//                 <Card
//                   key={task._id}
//                   className='hoverLshadow-md transition-shadow'
//                 >
//                   <Link
...
//               <CardTitle className='flex items-center justify-between'>
//                 In progress
//                 <Badge variant={'outline'}>{inProgresssTasks?.length}</Badge>
//               </CardTitle>
//             </CardHeader>

//             <CardContent className='p-3 space-y-3 max-h-[600px] overflow-y-auto'>
//               {inProgresssTasks?.map((task) => (
//                 <Card
//                   key={task._id}
//                   className='hoverLshadow-md transition-shadow'
//                 >

...
const Profile = () => {
    ...
    const handlePasswordChange = (values: ChangePasswordFormData) => {
        changePassword(values, {
            onSuccess: () => {
                toast.success(
                    'Password update successfully. You will be logged out. Please login again.'
                );
                form.reset();
    ...
    return (
        <div className="">
            <div className="px-4 md:px=0">
                ...
                <p>
                    Manage your account setting and preference.
                </p>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Update your presonal details.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...profileForm}>
                        <form
                        ...
                        >
                            ...
                            <div className="grid gap-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Ypu email address cannot be change.
                                </p>
                            </div>
                            <Button
                                type="submit"
